...
classname_to_id = {'Ascaris lumbricoides': 0,'Capillaria philippinensis': 1,'Enterobius vermicularis': 2,'Fasciolopsis buski': 3,'Hookworm egg': 4,'Hymenolepis diminuta': 5,
              'Hymenolepis nana': 6,'Opisthorchis viverrine': 7,'Paragonimus spp': 8,'Taenia spp. egg': 9,'Trichuris trichiura': 10}
...
if __name__ == '__main__':
    ...
    for annotation in annotations:
        key = str(annotation[0]).split(os.sep)[-1].split("'")[-1]
